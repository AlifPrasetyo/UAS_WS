					...
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Jalan leuwipanjang No.46 Kota Bandung</li>
								<li><i class="icon-phone2"></i>+629667602399</li>
								<li><i class="icon-mail"></i><a href="#">apoywisatabdg@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.apoywisatabdg.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
